                ...
                <div class="md:hidden space-y-3">
                    @foreach($faqs as $faq)
                        <div class="border border-gray-200 rounded-lg p-4">
                            ...
                            <div class="text-sm font-medium text-gray-900 mt-2">{{ Str::limit($faq->question, 80) }}</div>
                            <div class="text-sm text-gray-500 mt-1">{{ Str::limit($faq->answer, 100) }}</div>
                            <div class="text-sm text-gray-500 mt-2">Urutan: {{ $faq->order }}</div>

                            <div class="grid grid-cols-2 gap-2 mt-3">
                                <a href="{{ route('admin.faqs.edit', $faq) }}" class="inline-flex items-center justify-center px-3 py-2 rounded-md text-xs font-semibold bg-pink-50 text-pink-700 border border-pink-100 hover:bg-pink-100">
                                    Edit
                                </a>
