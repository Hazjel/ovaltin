    ...
    <div class="bg-white shadow-lg rounded-xl overflow-hidden">
        <div class="p-6 sm:p-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                    @if($product->image)
                        <img class="w-full h-64 sm:h-96 object-cover rounded-xl shadow-lg" src="{{ $product->image_url }}" alt="{{ $product->name }}" style="display: block !important; visibility: visible !important; opacity: 1 !important; max-width: 100%;" onerror="this.onerror=null; this.style.display='none'; this.nextElementSibling.style.display='flex';">
                    @else
                        <div class="w-full h-64 sm:h-96 bg-gradient-to-br from-pink-200 to-pink-200 rounded-xl flex items-center justify-center">
